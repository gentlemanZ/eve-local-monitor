...
### Changed
- Aligned runtime cache configuration with `config.ini`.
- Normalized OCR names and removed duplicate players before enrichment.
- Unified threat-level behavior across analyzer, CLI, and dashboard.
- Added architecture and testing contracts.

### Fixed
- Zero-danger/no-data players now consistently render as Unknown.
